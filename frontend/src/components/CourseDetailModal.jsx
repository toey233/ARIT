            ...
            <div style={{
                ...
                <div style={{
                    ...
                    {[
                        ...
                        { icon: HiOutlineClock, value: course.startDate && new Date(course.startDate) < new Date() ? 'สิ้นสุดการลงทะเบียน' : remaining <= 0 ? 'เต็มแล้ว' : (course.duration || `ลงทะเบียนถึง: ${formatDate(course.startDate)}`), color: (course.startDate && new Date(course.startDate) < new Date()) || remaining <= 0 ? '#dc2626' : '#f59e0b' },
