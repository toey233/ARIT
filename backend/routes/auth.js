...
router.put('/me', authenticateToken, async (req, res) => {
    try {
        const { phone, studentId, department, profilePicture, userType } = req.body;
        
        await query(
            `UPDATE users 
             SET phone = $1, "studentId" = $2, department = $3, "profilePicture" = $4, "userType" = $5
             WHERE id = $6`,
            [phone || '', studentId || '', department || '', profilePicture || '', userType || '', req.user.id]
        );
